    ...
    return Consumer<ModeloUsuario>(
      builder: (context, modeloUsuario, child) {
        return Scaffold(
          ...
          body: SingleChildScrollView(  // Asegura que el teclado no cubra los campos de texto
            child: Center(
              child: Padding(
                padding: const EdgeInsets.all(20),  // Espacio uniforme alrededor del contenido
                child: Column(
